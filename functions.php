...
function rhapsody_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'rhapsody_custom_background_args', array(
 ...
 */
function rhapsody_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'rhapsody_content_width', 640 );
}
add_action( 'after_setup_theme', 'rhapsody_content_width', 0 );
